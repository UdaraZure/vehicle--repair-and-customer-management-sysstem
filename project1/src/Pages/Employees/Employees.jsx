...
function Employees() {
  ...
  const [editedValues, setEditedValues] = useState({ EmpName: '', Description: '' });
  ...
  const validationSchema = Yup.object().shape({
    ...
    .test('is-before-today', 'Birthday should be a date before today', function (value) {
    ...
    axios
      ...
      .then((response) => {
        ...
        setEmployees((prevEmployees) =>
          prevEmployees.map((employee) => (employee.EmployeeID === id ? updatedEmployee : employee))
        );
      })
      .catch((error) => {
    ...
    <>
      <div className="EmployeeContainer">
        ...
        <Formik initialValues={initialValues} onSubmit={onSubmit} validationSchema={validationSchema}>
          ...
          <p style={{fontSize:"20px", fontWeight:"bold"}}>Add Employees</p>
            ...
            <Field id="InputEmployee" name="Address" className="field" placeholder="Address" />
            ...
            <Field id="InputEmployee" name="Email" className="field" placeholder="***@gmail.com" />
            ...
            <Field type="date" id="InputEmployee" name="BirthDay" className="field" placeholder="" />

            <label className="label">Start Date:</label>
            <ErrorMessage name="StartDate" component="span" />
            <Field type="date" id="InputEmployee" name="StartDate" className="field" placeholder="" />
            ...
            {employees.map((employee, index) =>
              employee.EmployeeID === editID ? ( 
                <tr key={employee.EmployeeID}>
                  ...
                  <td>
                    <button onClick={() => handleUpdate(employee.id, employees[index])}>Update</button>
                  </td>
                </tr>
              ) : (
                <tr key={employee.id}>
